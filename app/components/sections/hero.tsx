    ...
    >
      ...
      <div className="my-16 text-center animate-fade-in z-10 max-w-2xl px-6">
        <h2 className="text-base md:text-lg text-fg/50">
          I'm a Master's student in Data Science with a minor in Financial Engineering at EPFL, focused on quantitative modelling, systematic trading strategies and commodity markets.
        </h2>
      </div>
    </section>
  );
